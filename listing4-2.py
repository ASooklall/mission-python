...
# using room data, scenery data, and prop data
    ...
    if current_room % MAP_WIDTH: #if room is not on left of map
        room_to_left = GAME_MAP[current_room-1]
        #if room on left has a right exit, add a left exist in this room
        if room_to_left[4]:
